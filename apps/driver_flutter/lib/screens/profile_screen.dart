...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Driver Profile', style: GoogleFonts.poppins(color: Colors.black, fontWeight: FontWeight.bold)),
        actions: [
          if (!_isLoading)
            Padding(
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                        ...
                        Stack(
                          children: [
                            CircleAvatar(
                              ...
                              child: _profileImageUrl == null ? const Icon(Icons.drive_eta, size: 50, color: Colors.grey) : null,
                            ),
                            if (_isEditing)
                              Positioned(
                                bottom: 0,
                  ...
                  const SizedBox(height: 16),
                  _buildTextField(label: 'Full Name', controller: _nameController, enabled: _isEditing, icon: Icons.person_outline),
                  const SizedBox(height: 16),
                  Row(
                    children: [
                      Expanded(
                  ...
                  const SizedBox(height: 16),
                  _buildTextField(label: 'Phone Number', controller: _phoneController, enabled: _isEditing, icon: Icons.phone_outlined, keyboardType: TextInputType.phone),
                  const SizedBox(height: 16),
                  Row(
                    children: [
                      Expanded(child: _buildTextField(label: 'Date of Birth', controller: _dobController, enabled: false, icon: Icons.cake_outlined, hint: 'MM-DD-YYYY')),
                      const SizedBox(width: 16),
                      if (_isEditing)
                        TextButton.icon(
                          onPressed: _isSaving ? null : _updateAgeAndLicense,
                  ...
                  const SizedBox(height: 16),
                  _buildTextField(label: 'License Number', controller: _licenseController, enabled: _isEditing, icon: Icons.badge_outlined),
                  const SizedBox(height: 32),
                  ...
                  const SizedBox(height: 16),
                  _buildTextField(label: 'License Plate', controller: _plateController, enabled: _isEditing, icon: Icons.vpn_key_outlined),
                  const SizedBox(height: 32),
                  if (_isEditing)
                    SizedBox(
  ...
  Widget _buildSectionTitle(String title) {
    return Text(title, style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black));
  }

  Widget _buildTextField({required String label, required TextEditingController controller, required bool enabled, required IconData icon, TextInputType? keyboardType, String? hint}) {
    return TextField(
